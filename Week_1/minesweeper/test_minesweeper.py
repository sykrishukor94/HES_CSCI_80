...
class TestMinesweeper(unittest.TestCase):
    ...
    def test_corner_nested_mines(self):
        msAi = ms.MinesweeperAI(3,3)
        msAi.add_knowledge((0, 0), 1)
        msAi.add_knowledge((0, 1), 2)
        msAi.add_knowledge((0, 2), 2)
        msAi.add_knowledge((1, 0), 2)
        msAi.add_knowledge((2, 0), 2)
        move = msAi.make_safe_move()
        if move is None:
            move = msAi.make_random_move()
            if move is None:
                print(msAi.mines.copy())
